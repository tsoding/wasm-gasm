...
(define (i32.modulo_s a b)
  `(i32.rem_s (i32.add (i32.rem_s ,a ,b) ,b) ,b))
    ...
    (func $neighbors (export "neighbors")
          ...
          ,(for-local
            ...
            (for-local
             ...
             `(set_local $row ,(i32.modulo_s `(get_local $row) `(i32.const ,*height*)))
             '(set_local $col (i32.add (get_local $col0) (get_local $dcol)))
             `(set_local $col ,(i32.modulo_s `(get_local $col) `(i32.const ,*width*)))
